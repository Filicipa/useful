...
Модуль location для простого конфигурирования backend, который, к примеру, запущен в docker на порту 3000. А так же для второго контейнера приложения, запущенного на порту 8080 и настроенного на работу `/test`.
